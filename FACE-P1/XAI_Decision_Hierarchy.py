...
RdBl = color.LinearSegmentedColormap.from_list('blGrRdBl', ["black", "black", "black", "red"])
# plt.colormaps.register(RdBl)

blGrRdBl = color.LinearSegmentedColormap.from_list('blGrRdBl', ["black", "blue", "green", "red"])
...
def levelTwo(filename, original_image, all_fix_map, fixation_map, message):
    # print("In level 2")
    # print("Detecting weak camouflaged areas...")
    # print("")
